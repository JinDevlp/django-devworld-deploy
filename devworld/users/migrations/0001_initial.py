    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_field', models.CharField(blank=True, choices=[('Backend', 'BACKEND'), ('Frontend', 'FRONTEND'), ('Fullstack', 'FULLSTACK'), ('Data', 'DATA'), ('Devops', 'DEVOPS')], default=None, max_length=10, null=True)),
                ...
                ('profile_image', models.ImageField(blank=True, default='default_user.jpeg', null=True, upload_to='profiles/')),
